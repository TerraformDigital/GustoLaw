...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Oil & Gas Lawyer Calgary | Energy Legal Services Alberta | Gusto Law',
    }],
  },
  twitter: {
    card: 'summary',
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-teal-900 text-white py-16 md:py-24 overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-15 mix-blend-luminosity" style={{ backgroundImage: "url('https://gustolaw.ca/wp-content/uploads/2022/01/Oil-and-Gas-Lawyer-scaled.jpg')" }} />
