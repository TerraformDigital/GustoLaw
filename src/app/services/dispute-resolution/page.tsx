...
export const metadata = {
  ...
  description: 'Strategic dispute resolution for Alberta businesses. Shareholder disputes, contract disputes, mediation, arbitration, and settlement negotiation from experienced Calgary commercial lawyers.',
  keywords: 'dispute resolution Calgary, commercial dispute lawyer Alberta, shareholder dispute, contract dispute, mediation Calgary, arbitration lawyer, business litigation support',
}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Litigation is expensive, unpredictable, and distracting from running your business. Our approach prioritizes early resolution where it makes sense—but we prepare every matter as if it's going to trial. That preparation gives you leverage.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-8">
            <div className="border-b border-gray-200 pb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">What's the difference between mediation and arbitration?</h3>
              <p className="text-gray-600 leading-relaxed">In mediation, a neutral mediator helps parties negotiate a settlement—but the parties control whether to accept any deal. In arbitration, an arbitrator (or panel) hears evidence and arguments, then issues a binding decision. Mediation is collaborative; arbitration is adjudicative.</p>
            </div>
            <div className="border-b border-gray-200 pb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">How long do business disputes typically take to resolve?</h3>
              <p className="text-gray-600 leading-relaxed">It varies enormously. A straightforward negotiated settlement might resolve in weeks. Mediation typically adds 1-3 months. Arbitration can take 6-12 months. Court litigation in Alberta often takes 2-4 years to trial. Early, realistic assessment of your position usually leads to faster resolution.</p>
            </div>
            <div className="border-b border-gray-200 pb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">What is an oppression remedy?</h3>
              <p className="text-gray-600 leading-relaxed">Under the ABCA and CBCA, minority shareholders can seek relief if the corporation or its directors have acted in a manner that is oppressive, unfairly prejudicial, or unfairly disregards their interests. It's a powerful tool for minority shareholders—courts have wide discretion in crafting remedies, including ordering buyouts.</p>
            </div>
            <div className="border-b border-gray-200 pb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Should I try to resolve the dispute before involving lawyers?</h3>
              <p className="text-gray-600 leading-relaxed">It depends. Early direct communication can sometimes resolve issues quickly. But if there's significant money at stake, complex legal issues, or the relationship is already damaged, early legal advice helps you avoid mistakes—like missing limitation periods or making admissions that hurt your position later.</p>
            </div>
            <div className="pb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Do you handle court litigation?</h3>
              <p className="text-gray-600 leading-relaxed">We focus on dispute resolution before litigation and work with trusted litigation counsel when court proceedings are necessary. This lets us provide strategic guidance throughout while ensuring you have counsel experienced in courtroom advocacy when needed.</p>
            </div>
          </div>
        </div>
      </section>
